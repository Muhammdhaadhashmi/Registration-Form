...
class _EditUserState extends State<EditUser> {
  ...
  void initState() {
    setState(() {
      ...
      _userDepartmentController.text=widget.user.department??'';
      _userRollnumberController.text=widget.user.rollnumber??'';
      _userInterestController.text=widget.user.interest??'';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              //       errorText:
              //       _validateRollNumber ? 'Roll Number is required' : null,
              //     )),
              // const SizedBox(
              //   height: 20.0,
              // ),
